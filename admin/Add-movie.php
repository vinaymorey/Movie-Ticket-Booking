...
if (isset($_REQUEST['id'])) {
  ...
  mysqli_query($conn,"delete from add_movie where id='".$_REQUEST['id']."';");
...
if (mysqli_num_rows($result) > 0) {
  while($row = mysqli_fetch_array($result)) {
    ...
    <tr>
              ...
              <td>
              <a href="Add-movie.php?id=<?php echo $id;?>"><button data-toggle="modal" type="button" data-target="#delete_movie_modal<?php echo $id;?>" class="btn btn-danger btn-sm">Delete Movie</button>
              </td>
